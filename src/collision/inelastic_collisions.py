...
class FSInelasticVHSCollision(BaseCollision):
    ...
    def perform_precomputation(self):
        ...
        # Laplacian
        lapl = -math.pi ** 2 / self.sm.L ** 2 * idx_norm ** 2
        ...
        gain_kern *= wsigma
        # Exponential kernel
        exp = np.exp(-1j * math.pi * idx_mesh / self.sm.L)
        ...
        loss_kern *= wr_loss
        # Special function
        sp = self._sp_func(math.pi * r_loss * idx_norm / self.sm.L)
